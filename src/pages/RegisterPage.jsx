...
function RegisterPage({ onSwitchToLogin, onBackToHome, onRegisterSuccess }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute -top-32 -right-32 w-96 h-96 bg-secondary/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-primary/40 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Start tracking expiration dates and reducing waste today
          </p>
        </div>
